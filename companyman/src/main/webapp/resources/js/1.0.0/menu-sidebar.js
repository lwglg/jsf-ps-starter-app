...
(function () {
    ...
    function inicializarToggleDaSidebar() {
        var botaoAlternar = document.getElementById('sidebarToggle');
    ...
    function agruparItensDoSubmenu(cabecalho) {
        var itens = [];
        var proximoIrmao = cabecalho.nextElementSibling;
        ...
        function alternarSubmenu() {
            var colapsado = cabecalho.classList.toggle('submenu-collapsed');

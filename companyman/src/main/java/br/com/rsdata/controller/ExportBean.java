 ...
 * {@code br.com.rsdata.export.ExportDownloadServlet}. Este bean é
 * {@code @ApplicationScoped} porque só expõe as opções (enums) usadas
 * para popular os `f:selectItems` do formato e da origem dos dados —
 * não guarda nenhum estado de requisição.
 */
@Named
@ApplicationScoped
